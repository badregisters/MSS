...
| 节点防抖 | 自动测速 50ms 容差 / 地区组 75ms，多级容差防频繁切换 |
...
| 策略组 | 类型 | 说明 |
|:-------|:----:|:-----|
| 🚀 节点选择 | select | 主入口，手动选择或委托子组 |
| 📡 自动测速 | url-test 50ms | `regional` 标签机场节点中最优选 |
| 🎛️ 手动切换 | select | 全量节点手动选 |
| 🎬 影音节点 | url-test 75ms | `economy` 标签机场中过滤 实验性 / 1x 倍率 / 流媒体 关键词节点 |
| 🚄 Speedtest | select | 测速专用，默认走自动测速 |
